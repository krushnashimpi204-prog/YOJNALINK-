...
function init(){
  ...
  $('adminSignOutBtn').onclick=()=>{if(confirm(t('signOut')+'?')){sessionStorage.removeItem(ADMIN_SESSION_KEY);sessionStorage.removeItem(PHONE_KEY);location.href='login-c.html'}};
  if(me.role==='primary'){
